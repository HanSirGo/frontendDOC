...
![1716110298168](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\1716110298168.png)
...
**「Windows 电脑」**，右键点击 Chrome 浏览器 -> 属性 -> 目标 -> 在 `chrome.exe` 路径后面添加代码 `--disable-web-security --user-data-dir="<自定义目录>"`。(`<自定义目录>` 例如：`D:\MyChromeData`)![1716110367684](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\1716110367684.png)

后续打开该 Chrome 浏览器应用，都是以禁用浏览器同源策略的方式打开。如果设置成功了，打开 Chrome 浏览器会有如下提示：

![1716110382964](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\1716110382964.png)
...
![1716110399354](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\1716110399354.png)

**「步骤二」**：固定插件到导航栏，并点击启用 CORS Unblock 插件。

![1716110416627](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\1716110416627.png)

![1716110439272](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\1716110439272.png)
...
![1716110454236](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\1716110454236.png)

跨域请求失败

**「启动插件后」**：跨域请求被自动添加了 CORS 配置，请求成功

![1716110469076](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\1716110469076.png)
...
![1716110490444](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\1716110490444.png)

charles

**「步骤二」**：添加 Rewrite 配置

![1716110504667](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\1716110504667.png)

charles

**「步骤三」**：Add 时添加 CORS 配置响应头

![1716110520266](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\1716110520266.png)

charles

通过完成上述的三个步骤，我们现在就可以直接访问跨域接口了，可以看到所有的接口响应上都已经被添加了 `Access-Control-Allow-Origin:*` CORS 属性。

![1716110566343](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\1716110566343.png)
...
![1716110601727](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\1716110601727.png)
...
![1716110631239](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\1716110631239.png)
